...
def private_access_http_test(url):
    requests.delete(url + 'clear')
    data_in = {
        'email' : "email1@gmail.com",
        'password' : "password",
...
def invalid_token_http_test(url): # non integer token - accesserror
    requests.delete(url + 'clear')
    data_in = {
        'email' : "email2@gmail.com",
        'password' : "password",
...
def missing_user_http_test(url): # wrong user token - accesserror
    requests.delete(url + 'clear')
    data_in = {
        'email' : "email2@gmail.com",
        'password' : "password",
