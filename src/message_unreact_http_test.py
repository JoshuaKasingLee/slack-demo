...
def test_unreact_one_http_test(url):
    ...
    response = requests.post(url + 'message/unreact', json = data_in)
    data_in = {
        'token': token,
        'query_str': 'o',
    }
...
def test_remove_unreact_keep_one_http_test(url):
    requests.delete(url + 'clear')
    data_in = {
        'email': "jonathon@gmail.com",
        'password': "password",
...
def test_two_unreacts_http_test(url):
    requests.delete(url + 'clear')
    data_in = {
        'email': "jonathon@gmail.com",
        'password': "password",
...
def test_message_already_unreacted_http_test(url):
    requests.delete(url + 'clear')
    data_in = {
        'email': "jonathon@gmail.com",
        'password': "password",
...
def test_invalid_unreact_id_http_test(url):
    requests.delete(url + 'clear')
    data_in = {
        'email': "jonathon@gmail.com",
        'password': "password",
