...
def test_valid_user():
    ...
    correct_profile = {"u_id" : user_details['u_id'], "email" : "kellyczhou@gmail.com", \
...
def test_valid_users():
    ...
    correct_profile1 = {"u_id" : user1['u_id'], "email" : "cyruschow@gmail.com", \
        "name_first": "Cyrus", "name_last": "Chow", "handle_str": "cyruschow"}
    correct_profile2 = {"u_id" : user2['u_id'], "email" : "andreeavissarion@hotmail.com", \
        "name_first": "Andreea", "name_last": "Vissarion", "handle_str": "andreeavissarion"}
    assert(profile1 == correct_profile1)
    assert(profile1 == correct_profile2)
    clear()
